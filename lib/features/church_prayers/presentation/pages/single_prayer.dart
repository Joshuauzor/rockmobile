...
class SinglePrayer extends StatefulWidget {
  final SinglePrayerArgs params;
  const SinglePrayer({required this.params, Key? key}) : super(key: key);

  @override
  _SinglePrayerState createState() => _SinglePrayerState();
}
